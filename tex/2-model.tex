...
In non-cooperative game theory, Nash equilibria are the standard solution concept for determining optimal strategies. In signalling games, one usually needs more a refined concept, due to the players not knowing the beliefs of the other players correctly. These are called \emph{perfect Bayesian equilibria}, see \cite{Fudenberg-Tirole_1991_paper}. We will, however, not solve for this solution concept in this paper, as our game will be of a deliberately simple nature where this full generality is unnecessary. 
