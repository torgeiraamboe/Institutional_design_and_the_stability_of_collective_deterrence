...
In the simple case that each coalition member $i$ has an equal weight, say $w_i = 1$ for all $i$, and the threshold $\tau$ is a positive integer less than or equal to $n$, then these probabilities become binomial, with 
