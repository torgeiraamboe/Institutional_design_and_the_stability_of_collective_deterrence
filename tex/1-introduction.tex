...
To understand the interactions between deterrence and institutional design, we characterize the model's perfect Bayesian equilibria, and study the credibility-false positive frontier. By approximating the probability of retaliation by a normal distribution this allows us to study optimal thresholds for large coalitions via binormal Receiver Operating Characteristic (ROC) curves \citeme. We also study optimal thresholds and voting rules for small alliances, such as the nordic countries, via associated empirical ROC curves. 
